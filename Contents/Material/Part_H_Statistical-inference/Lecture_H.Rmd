...
Computer power allows us to use computational statistics and to work empirically with theoretical statistical concepts such as the Central Limit Theorem, sampling distributions of statistics and confidence intervals. 

It is quite straightforward to repeatedly draw random samples from a distribution or data set. The interpretation of a 95% CI becomes more clear when you see the results of estimating 100 times a 95% CI for a sample mean. 
