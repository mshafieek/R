...
12. **Open the Markdown file `SimulationConfidenceIntervals.Rmd`.** Examine the code and verify that you understand what is being done. Run the code. Then run the code again but change the random seed at the top of the document. What happens with the coverage probability?
