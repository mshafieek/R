...
# add your code here to create an empty matrix
...
- `for(i in 1:reps) {`. This line starts the for loop and dictates that we are going to repeat the code within the loop 1 through 25 - so 25 times in total. 
