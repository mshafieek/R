...
for (i in 1:folds) {
  ...
  mse_lin[i] <- mean((cars$speed[test_id[[i]]] - pred)^2)     # test MSE of the i-th fold
...
for (i in 1:folds) {
  ...
  mse_quad[i] <- mean((cars$speed[test_id[[i]]] - pred)^2)     # test MSE of the i-th fold
...
for (i in 1:folds) {
  ...
  mse_cub[i]  <- mean((cars$speed[test_id[[i]]] - pred)^2)     # test MSE of the i-th fold
