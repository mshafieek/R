...
6.  **Make a new dataframe called `dat3b` where you use the matrix `mat3` from `Question 4`. Use function `as.data.frame()` and inspect the help file of this function.**
