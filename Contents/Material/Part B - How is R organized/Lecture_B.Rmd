...
- How to assign elements to objects with `<-` (alt/option -)
- How to run code
- How to save `R`-scripts
- How to organize your work with projects in `RStudio`
...
## Calling one element in data frames
```{r echo=FALSE}
d
```
### How can I select element "b"?

<center>
<img src="figures/Wooclap_HowToParticipate.png" alt="HTML5 Icon" width = 90%>
</center>
