...
Open the `RStudio` project that you created in the first practical by clicking on the `Practicals.RProj` file. Open a new R script file or a R Markdown file.
