...
Open the `RStudio` project that you created in the first practical by clicking on the `Practicals.RProj` file. Open a new R Markdown file.
...
<center>
<img src="figures/Structure_RObjects_Data_tab.png" alt="HTML5 Icon" width = 65%>
</center>
